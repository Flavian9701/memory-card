...
function startGame(){
    ...
    for(var i = 0; i < 24; i++){                                 // creo il container delle carte e le carte
      var box = document.createElement('div');
      var element = document.createElement('div');
      element.className = 'icon';                               // assegno una classe
      document.getElementById('griglia').appendChild(box).appendChild(element);
      element.innerHTML = arrayShuffle[i];                      // gli passo l'array misto
    }
